...
export function OtherApps() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cards = sectionRef.current.querySelectorAll(`.${styles.stackCard}`);
                ...
                <div className={styles.cardContent}>
                  ...
                  <div className={styles.cardInfo}>
                    ...
                    <div className={styles.platforms}>
                      ...
                      {project.platforms.includes("ios") && project.iosUrl && (
                        <a
                          href={project.iosUrl}
                          target="_blank"
                          rel="noopener noreferrer"
                      ...
                      {project.platforms.includes("android") && project.androidUrl && (
                        <a
